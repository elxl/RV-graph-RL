...
class Request:
    def __init__(self, request_id, origin, destination, entry_time, origin_longitude, origin_latitude, destination_longitude, destination_latitude, ideal_traveltime=0, boarding_time=None, alighting_time=None, latest_boarding=None, latest_alighting=None,
